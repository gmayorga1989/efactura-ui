...
/**
 * Layout de autenticación alineado con Hope UI (`dashboard/auth/sign-in.html`):
 * panel izquierdo (marca + contenido) e ilustración derecha.
 */
@Component({
  selector: 'ts-login-shell',
  standalone: true,
  template: `
    <div class="wrapper">
      <section class="login-content">
        <div class="row m-0 align-items-center bg-white vh-100">
                ...
                >
                  <div class="card-body z-3 px-md-0 px-lg-4">
                    <div class="navbar-brand d-flex align-items-center mb-3">
                      ...
                      <h4 class="logo-title ms-3 mb-0">{{ brandTitle() }}</h4>
                    </div>
                    <ng-content />
                  </div>
                </div>
          ...
          <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
            <img
              src="assets/vendor/hope-ui/images/auth/01.png"
...
export class TsLoginShellComponent {
